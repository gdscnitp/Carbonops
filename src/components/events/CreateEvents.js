...
export default function CreateEvents() {
  ...
  const handleSubmit = (event) => {
    event.preventDefault();
      ...
      if(values.eventName.length>0 && values.eventLocation.length>0  && values.enqNumber.length>0  && values.audience.length>0  && values.eventDescription.length>0 ){
        if(values.enqNumber.length===10)
          console.log(values);
          else
          console.log("Phone no. must be 10 digit long");
      }
    ...
    <>
      ...
      <div className={styles.formBody}>
        ...
        <div className={styles.formMid}>
          <form>
            <label className={`${styles.label} ${styles.eventName}`} htmlFor="eventName">
              Your Event Title* <br />
              <input
                type="text"
                id="eventName"
            ...
            <label className={`${styles.label} ${styles.eventLocation}`} htmlFor="eventLocation">
        ...
        <div className={styles.formRight}>
          <form>
            ...
            <label className={styles.eventDescription} htmlFor="eventDescription">
